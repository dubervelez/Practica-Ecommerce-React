    ...
    <div className='contenedor-producto'>
        ...
        <div className='contenedor-eleccion'>
            <div className='resumen-compra'>
                <img className='quitar-producto' src={eliminar} alt="icon eliminar" />
                <p className='cantidad-producto'>0</p>
                <img className='agregar-producto' src={agregar} alt="icon agregar" />
            </div>
            <button>
